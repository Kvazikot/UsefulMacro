...
## Промотка видео наклоном головы. Обратное обучение с подкреплением. Обучение дикарей не знающих английского.
...
Это может быть полезно если вы пытаемся делать устройство которое обучает людей языку, которого они не знают.
