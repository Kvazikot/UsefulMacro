...
## Дальнейшие планы
В этой работе применяется классический варварский подход. 
...
При желании вы можете работать с удаленными машинами в правом окне хрома. Для этого вам все же надо будет почитать чисто поверхностно про то что такое ssh и X server.
...
Второе - это избавление от костыля crc32. Выбор входного списка из внешнего скрипта. 
