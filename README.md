...
## Выбор ключевых слов из разных кластеров. Кластеризация статей википедии по алгоритму.
...
Для чего я попробую выложить скрипт который составляет большой список вопросов на разные темы, используя базу quora.
